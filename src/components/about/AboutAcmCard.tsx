...
export const AboutAcmCard = () => {
  return (
    <div className="flex justify-center items-center my-8 p-4">
      <div className="backdrop-blur-md bg-white/10 rounded-[30px] md:rounded-[60px] px-8 py-8 md:px-24 md:py-12 max-w-lg md:max-w-2xl text-white border-2 border-white/40">
