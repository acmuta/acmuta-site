...
import { getCommittee, getProjects, type Committee, type Project } from "@/lib/api";
        ...
        <div className="wrap">
          <Reveal>
            ...
            <div className="cd-hero">
              <div>
                <div className="cd-logo ph" data-ph="">
                  <CommitteeLogo committee={committee} size={48} />
                </div>
                <span
                  className="tag mono"
          ...
          <div className="wrap">
            <div className="sec-head row">
              <Reveal>
                ...
                >
                  From this <span className="dim">committee.</span>
                </h2>
              </Reveal>
              <Reveal>
