  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (rocket) {
        ...
        rocket.style.transform = `translate(${scrollY * Math.cos(angle)}px, -${
            ...
            <div className="relative my-32 max-w-lg md:max-w-2xl mx-auto  md:ml-24">
              ...
              <div className="relative z-40 backdrop-blur-md bg-white/10 w-[90%] md:w-full rounded-[30px] md:rounded-[60px] px-8 py-8 md:px-20 md:py-10 text-white border-2 border-white/40 mx-auto -mt-6 md:mt-0">
                ...
                <p className="text-lg md:text-xl leading-relaxed font-medium">
                  ...
                  students through technology. Join our inclusive community to
                  learn, collaborate, create, and grow, no matter your
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 mx-auto">
        ...
        <div className="flex justify-center items-center">
          <div className="w-40 h-32 md:w-80 md:h-52">
            <Image
              src="/assets/partners/paycom-logo.png"
              alt="Paycom"
        ...
        <div className="flex justify-center items-center">
          <div className="w-40 h-32 md:w-80 md:h-52">
            <Image
              src="/assets/partners/perplexity-logo.png"
              alt="Perplexity"
              className="w-full h-full object-contain"
              width={200}
              height={200}
        ...
        <div className="flex justify-center items-center">
          <div className="w-40 h-32 md:w-80 md:h-52">
            <Image
              src="/assets/partners/mouser-logo.png"
              alt="Mouser"
              className="w-full h-full object-contain"
              width={200}
              height={200}
