  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (rocket) {
        ...
        rocket.style.transform = `translate(${scrollY * Math.cos(angle)}px, -${scrollY * Math.sin(angle)}px)`;
      }
    };
      ...
      <div className="overflow-x-hidden">
        <main className="flex min-h-screen flex-col justify-between">
          ...
          <div className="relative overflow-hidden">
            {/* Rocket asset */}
            <div id="rocket" className="absolute bottom-0 left-0 w-[300px] h-[300px] md:w-[420px] md:h-[420px] z-50">
                <Image
